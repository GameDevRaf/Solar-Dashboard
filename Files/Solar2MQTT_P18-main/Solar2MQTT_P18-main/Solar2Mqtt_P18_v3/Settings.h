...
public:
  ...
  String _deviceName = "solardata";    //name of the device
  String _mqttServer = "139.135.57.93";    //host or ip from the mqtt server
  String _mqttUser = "raf";      //mqtt username to login
  String _mqttPassword = "Javaria11";  //mqtt passwort
  String _mqttTopic = "solardata";     //MQTT Topic
  short _mqttPort = 1883;        //mqtt server port
  short _mqttRefresh = 10;     //mqtt Send Interval in Seconds
